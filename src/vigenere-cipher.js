class VigenereCipheringMachine {
  ...
  encrypt(message, key) {
    ...
    return this.type === 'reverse' ? encryptedMessage.split('').reverse().join('').toUpperCase() : encryptedMessage.toUpperCase()
  }
  ...
  decrypt(encryptedMessage, key) {
    ...
    return this.type === 'reverse' ? message.split('').reverse().join('').toUpperCase() : message.toUpperCase()
  }
